/* ---- Lenis smooth scroll (matteofabbiani-style) ---- */
  ...
  (function(){
    ...
    document.querySelectorAll(".bhero-card,.lets-card").forEach(e=>e.dataset.lum="0.08");
    ...
    const hot="nav .mail,.crumb a,.ab-follow a,.lets-nav a,.lets-social a,.lets-card .email,.m-close,.m-slink";
